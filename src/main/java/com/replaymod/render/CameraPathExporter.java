...
public class CameraPathExporter {
    ...
    public void recordFrame(float tickDelta) {
        //#if MC>=10800
        Entity entity = mc.getRenderViewEntity() == null ? mc.thePlayer : mc.getRenderViewEntity();
        //#else
        ...
        //$$ Vec3d vec = camera.getProjectedView();
    ...
    public void finish() throws IOException {
        ...
        glTF.addCameras(configure(new Camera(), camera -> {
            ...
            camera.setPerspective(configure(new CameraPerspective(), perspective -> {
                ...
                perspective.setYfov((float) Math.toRadians(mc.gameSettings.fovSetting));
